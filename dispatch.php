<?php
   ...
   $btnDispatchClicked = isset($_POST["btnDispatchClicked"]);
      ...
      <div class="form-group row">
       ...
       <div class="form-group row">
        <div class="offset-sm-4 col-sm-8">
          <button type="submit" class="btn btn-primary" name="btnDispatchClicked" id="submit">Dispatch</button>
        </div>
      </div>
